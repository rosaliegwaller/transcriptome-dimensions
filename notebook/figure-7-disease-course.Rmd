...
p1 = ggsurvplot(survfit(Surv(time = pdt$tme, event = pdt$evt) ~ trt, data=pdt),palette=cbPalette[c(6,1,7)])
p1
ggsave(filename = "plots/os_kmplot.pdf",plot = p1,width=7.5,height=2.5)
```
